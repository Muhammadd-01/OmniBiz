...
-- CreateIndex
CREATE UNIQUE INDEX "TenantModule_tenantId_businessModuleId_key" ON "TenantModule"("tenantId", "businessModuleId");
...
-- AddForeignKey
ALTER TABLE "TenantModule" ADD CONSTRAINT "TenantModule_businessModuleId_fkey" FOREIGN KEY ("businessModuleId") REFERENCES "BusinessModule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
